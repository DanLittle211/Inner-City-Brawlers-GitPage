...
public class RoundManager : MonoBehaviour
{
    ...
    public void PauseGame()
    {
        ...
        p2Movement.player.controllers.maps.LoadMap(ControllerType.Keyboard, 1, "Menu", "Default", true);
        p2Movement.player.controllers.maps.LoadMap(ControllerType.Joystick, 1, "Menu", "Default", true);
    ...
    public void UnpauseGame()
    {
        ...
        pauseMenu.SetActive(false);
        p1Movement.player.controllers.maps.LoadMap(ControllerType.Keyboard, 0, "Default", "Player1", true);
        p1Movement.player.controllers.maps.LoadMap(ControllerType.Joystick, 0, "Default", "Player1", true);
        p2Movement.player.controllers.maps.LoadMap(ControllerType.Keyboard, 1, "Default", "Player2", true);
        p2Movement.player.controllers.maps.LoadMap(ControllerType.Joystick, 1, "Default", "Player2", true);
        currentState = roundState.duringRound;
    }
