...
public class PlayerButtons : MonoBehaviour
{
    ...
    #region Enemy Variables for Attacks
    ...
    #region Animator and Combo Lists
    ...
    #region Code gauging distance from opponent for blocking
    ...
    void PrimeCombo()
    {
        ...
        //combo listener for searching for correct inputs
    }
    ...
    void Start()
    {
        ...
        //gives combo counter to respective player based on Player ID
        ...
        //sets starting values and variables for beginning of game
    }
    ...
    void Update()
    {
        ...
        if (pM.isDisabled == false)
        {
            GameControls();
            checkForBlock();
            //While not disabled players can attack and block
        }
    ...
    public void Attack(Attack A)
    {
        ...
        //when an attack button is pressed, it plays the animation associated with it and detects if the opponent is within hitting distance of the overlap circle
        ...
        //checks previous state and sets them back to said state
    }
    ...
    IEnumerator RunAnimForLength(float time)
    {
        ...
        //while this coroutine runs, the player's bool for attacking is true
    }
    ...
    void ResetCombos()
    {
        ...
        //isAttacking = false;
        currentCombos.Clear();
        //resets combo leeway timer a restarts check for special combos
    }
